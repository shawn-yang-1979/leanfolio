...
## 依據觀測頻率決定 T-Shirt Size 額度
接下來我們就可以開始觀察 KD 指標, 決定我們是否要買進, 以及買進多少金額.

千萬不要一直盯盤, 那只是在浪費生命, 還會影響你的工作. 定時觀測即可.

觀測頻率分為每日, 每週, 每月; 對應不同的觀察指標以及 T-Shirt Size 額度. 每日額度最小, 每月額度最高. 

當觀測時間到了, 你就觀察一下是不是有哪一檔個股符合買進的交易規則. 如果符合, 就用相對應的 T-Shirt Size 額度買進固定的金額.

| 頻率 | 觀察指標  | T-Shirt Size | 公式                                        | Example                              |
| ---- | -------- | ------------ | ------------------------------------------- | ------------------------------------ |
| 每日 | 還原日 KD | S            | 可投入總金額 * 投資組合比例 / 10 檔個股 / 100 | 8,000,000 * 30% / 10 / 100 =   2,400 |
| 每週 | 還原週 KD | M            | 可投入總金額 * 投資組合比例 / 10 檔個股 / 10  | 8,000,000 * 30% / 10 / 10  =  24,000 |
| 每月 | 還原月 KD | L            | 可投入總金額 * 投資組合比例 / 10 檔個股       | 8,000,000 * 30% / 10       = 240,000 |
